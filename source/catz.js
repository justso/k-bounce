...
,   height = 3 // height of wobbling in pixels
,   alink = "" // page to link text to (set to ="" for no link)
;
...
function initMenu() {
    ...
    $('#menu_button').hover(
        ...
        function () {
            ...
            if (bg_span.hasClass("show")) bg_span.animate({
                top: "10px",
                opacity: 1
            }, 200);
            else bg_span.animate({
                top: "0px",
                opacity: 1
            }, 200);
        }, function () {
    ...
    $('#menu_button').toggle(
        ...
        function () {
            $("#menu_button span").fadeOut("fast", function () {
                $(this).removeClass("show").addClass("hide").css({
                    top: "0px",
                    opacity: 1
                }).fadeIn("fast");
            });
            ...
            $("#menu_button span").fadeOut("fast", function () {
                $(this).removeClass("hide").addClass("show").css({
                    top: "10px",
                    opacity: 1
                }).fadeIn("fast");
            });
